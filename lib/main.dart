...
void main() {
  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider<FacialRecognitionProvider>(create: (_) => FacialRecognitionProvider(ApiService())),
        ChangeNotifierProvider<FacialLoginProvider>(create: (_) => FacialLoginProvider(ApiService())),
        ChangeNotifierProvider<ScrollProvider>(create: (_) => ScrollProvider()),
        ChangeNotifierProvider<ObjetosProvider>(create: (_) => ObjetosProvider(ApiService())),
        ChangeNotifierProvider<RegisterProvider>(create: (_) => RegisterProvider(ApiService())),
        // Otros proveedores
      ],
      child: const MyApp(),
    ),
