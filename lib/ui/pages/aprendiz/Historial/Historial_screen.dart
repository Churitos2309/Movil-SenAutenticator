...
class _HistorialScreenState extends State<HistorialScreen> {
  ...
  Future<List<dynamic>> fetchObjetos() async {
    try {
      ...
      final response = await apiService.get('objeto/');
      if (response.isEmpty) {
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final imageUrl = objeto['foto_objeto'] != null
                      ? 'https://senauthenticator.onrender.com${objeto['foto_objeto']}'
                      : '';
                  ...
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          // Mostrar la imagen desde la URL de la API
                          imageUrl.isNotEmpty
                              ? Image.network(
                                  imageUrl,
                                  height: 100,
