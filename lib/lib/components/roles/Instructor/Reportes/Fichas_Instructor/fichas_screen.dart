      ...
      body: Padding(
        ...
        child: isLoading
            ...
            : errorMessage.isNotEmpty
                ...
                : fichas.isEmpty
                    ? Center(
                        child: Text('No hay fichas disponibles.',
                            style: TextStyle(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: ConstrainedBox(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: DataTable(
                                showCheckboxColumn:
                                    false, // Ocultar columna de selección
                                columnSpacing:
                                    16.0, // Ajustar espacio entre columnas
                                dataRowHeight:
                                    50.0, // Ajustar altura de filas de datos
                                headingRowHeight:
                                    50.0, // Ajustar altura de filas de encabezado
                                headingRowColor: MaterialStateColor.resolveWith(
                                  (states) => const Color(0xFF39a900),
                                ),
                                dataRowColor: MaterialStateProperty.resolveWith(
